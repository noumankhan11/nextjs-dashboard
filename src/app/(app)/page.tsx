  ...
  return (
    <div>
      <main className="flex-grow flex flex-col items-center justify-center px-4 md:px-24 py-12 bg-gray-800 text-white">
        ...
        <Carousel className="w-full max-w-xs p-6 bg-gray-50 border border-gray-200 rounded-lg shadow-md">
            ...
            {messages.map((message, index) => (
              <CarouselItem
                ...
                <Card className="bg-white border border-gray-200 rounded-lg shadow-lg">
                  <CardHeader className="bg-gray-100 border-b border-gray-200 p-3 rounded-t-lg">
